...
include 'sql/conexao.php';  // include com arquivo de conexao
include 'rezise-class.php';
...
$consulta = $connection->query("SELECT ds_capa FROM tbl_livro WHERE cd_livro='$cd_livro'");
...
try {
    ...
    $alterar = $connection->query("UPDATE tbl_livro SET  
